...
average_msld = sum([x for x in compounds['msld']]) / len(compounds['msld'])

compounds['abs_msld']  = []
for i in compounds['msld']:
    #print(i)
...
print([round(x, 1) for x in compounds['abs_msld']],  [round(x, 1) for x in compounds['msld_unc']])
#-----------------------------
...
plt.errorbar(compounds['expt'], compounds['abs_msld'], yerr=compounds['msld_unc'], fmt='', linestyle='', color='red', alpha=0.4)

...
mpirun -np 1 -x OMP_NUM_THREADS=8 --bind-to none --map-by node $CHARMMEXEC iflat=$i esteps=20000 nsteps=4000000 seed=$RANDOM lam=$i -i ../msld_flat.inp > output 2> error

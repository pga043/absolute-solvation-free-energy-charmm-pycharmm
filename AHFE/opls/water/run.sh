...
mpirun -np 1 -x OMP_NUM_THREADS=1 --bind-to none --map-by node $CHARMMEXEC iflat=$i esteps=500000 nsteps=2500000 seed=$RANDOM lam=$i -i ../msld_flat.inp > output 2> error

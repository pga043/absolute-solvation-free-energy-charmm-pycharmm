...
read.rtf('prep/toppar/top_all36_prot.rtf')
read.prm('prep/toppar/par_all36m_prot.prm', flex=True)
read.stream('prep/toppar/toppar_water_ions.str')
settings.set_bomb_level(-2)
read.rtf('prep/toppar/top_all36_cgenff.rtf', append=True)
read.prm('prep/toppar/par_all36_cgenff.prm', flex=True, append=True)
settings.set_bomb_level(0)
read.stream(f'prep/{solres}_rg.str')
